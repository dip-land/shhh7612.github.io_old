window.addEventListener('load', () => {
    for (let widget of document.getElementsByTagName('discord-widget')) {
        ...
        let footer_text = widget.getAttribute('footer-text') ?? '';
        ...
        //style
        //https://shhh7612.github.io/plugins/widget/style.css
        widget.innerHTML = '<link rel="stylesheet" href="/plugins/widget/style.css">'
